...
public class MathUtils {
  ...
  } catch (Throwable __dp_ex_d64ce820c1e141ee89b6c0cdfa402334_en0) {
      String __json = "{\"type\":\"INV_FAIL\"," + "\"id\":\"d64ce820-c1e1-41ee-89b6-c0cdfa402334\"," + "\"error\":\"" + __dp_ex_d64ce820c1e141ee89b6c0cdfa402334_en0.toString() + "\"}";
  ...
  if (a < 0) throw new IllegalArgumentException("negative a not allowed");
    {
        ...
        } catch (Throwable __dp_ex_ca653e6a045e4849acc954008d8e9bfa_ex1_0) {
            String __json = "{\"type\":\"INV_FAIL\"," + "\"id\":\"ca653e6a-045e-4849-acc9-54008d8e9bfa\"," + "\"error\":\"" + __dp_ex_ca653e6a045e4849acc954008d8e9bfa_ex1_0.toString() + "\"}";
  ...
  public static int max(int a, int b) {
    {
        ...
        } catch (Throwable __dp_ex_aeac8e1147384655a374c7800b333ad7_ex1_0) {
            String __json = "{\"type\":\"INV_FAIL\"," + "\"id\":\"aeac8e11-4738-4655-a374-c7800b333ad7\"," + "\"error\":\"" + __dp_ex_aeac8e1147384655a374c7800b333ad7_ex1_0.toString() + "\"}";
        ...
        } catch (Throwable __dp_ex_4cf47b4b730d419dae60e38447db0a92_ex1_1) {
            String __json = "{\"type\":\"INV_FAIL\"," + "\"id\":\"4cf47b4b-730d-419d-ae60-e38447db0a92\"," + "\"error\":\"" + __dp_ex_4cf47b4b730d419dae60e38447db0a92_ex1_1.toString() + "\"}";
        ...
        } catch (Throwable __dp_ex_a2fcdc367ec94e26b4e7fb51103655e0_ex1_2) {
            String __json = "{\"type\":\"INV_FAIL\"," + "\"id\":\"a2fcdc36-7ec9-4e26-b4e7-fb51103655e0\"," + "\"error\":\"" + __dp_ex_a2fcdc367ec94e26b4e7fb51103655e0_ex1_2.toString() + "\"}";
