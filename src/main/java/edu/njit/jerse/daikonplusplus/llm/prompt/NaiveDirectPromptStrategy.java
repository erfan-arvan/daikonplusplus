...
/**
 * Minimal prompt strategy that directly asks the model to generate invariants without additional
 * guidance, constraints, or examples.
 *
 * <p>This strategy provides only basic instructions, the program point, in-scope variables, and
 * optional context. It is intended as a simple baseline for comparison against more structured
