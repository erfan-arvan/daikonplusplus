 ...
 *
 * <p>Examples are inserted into the system instructions via {@link FewShotExampleProvider},
 * allowing the model to observe input-output patterns alongside the general rules.
 */
